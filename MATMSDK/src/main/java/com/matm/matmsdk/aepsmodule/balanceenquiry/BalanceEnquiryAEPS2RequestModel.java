...
public class BalanceEnquiryAEPS2RequestModel {
    ...
    public BalanceEnquiryAEPS2RequestModel(){
    ...
    public String toString() {
        return "BalanceEnquiryAEPS2RequestModel{" +
                "amount='" + amount + '\'' +
                ", aadharNo='" + aadharNo + '\'' +
                ", virtualId='" + virtualId + '\'' +
                ", ci='" + ci + '\'' +
