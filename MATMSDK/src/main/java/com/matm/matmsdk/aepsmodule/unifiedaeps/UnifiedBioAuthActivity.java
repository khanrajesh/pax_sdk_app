        ...
        AndroidNetworking.post("https://us-central1-iserveustaging.cloudfunctions.net/pincodeFetch/api/v1/getCitystateAndroid")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (status.equalsIgnoreCase("success")) {
                                ...
                                hideLoader();
                                Toast.makeText(UnifiedBioAuthActivity.this, "Invalid area pin, please try after sometimes", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                            hideLoader();
                    ...
                    public void onError(ANError anError) {
                        anError.getErrorBody();
                        hideLoader();
                        Toast.makeText(UnifiedBioAuthActivity.this, "Invalid area pin, please try again.", Toast.LENGTH_SHORT).show();
