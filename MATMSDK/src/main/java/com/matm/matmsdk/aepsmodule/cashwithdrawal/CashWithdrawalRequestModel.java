...
public class CashWithdrawalRequestModel {
    ...
    public CashWithdrawalRequestModel(String amount, String aadharNo,  String ci, String dc, String deviceSerial, String dpId, String encryptedPID, String freshnessFactor, String hMac, String iin, String mcData, String mi, String mobileNumber, String operation, String rdsId, String rdsVer, String sKey,String paramA,String paramB,String paramC) {
        this.amount = amount;
    ...
    public String toString() {
        return "CashWithdrawalRequestModel{" +
                "amount='" + amount + '\'' +
                ", aadharNo='" + aadharNo + '\'' +
                ", virtualId='" + virtualId + '\'' +
                ", ci='" + ci + '\'' +
