...
public class CashWithDrawalContract {
    ...
    interface UserActionsListener {
        void performCashWithdrawal(String retailer, String token, CashWithdrawalRequestModel cashWithdrawalRequestModel);
        void performCashWithdrawalAEPS2(String token, CashWithdrawalAEPS2RequestModel cashWithdrawalRequestModel);
