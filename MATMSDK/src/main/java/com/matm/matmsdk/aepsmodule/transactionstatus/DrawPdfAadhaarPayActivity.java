...
public class DrawPdfAadhaarPayActivity extends AppCompatActivity {
    ...
    private String operationPerformed = "AadhaarPay";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_draw_pdf_aadhaar_pay);
