    ...
    private void checkAppInstalledOrNot(String packageName) {
        ...
        try {
            if (installed) {
                ...
                } else if (SdkConstants.DEVICE_TYPE.equalsIgnoreCase("Wiseasy")) {
                    sendDataToService(packageName, "Wiseasy");
                } else if (SdkConstants.DEVICE_TYPE.equalsIgnoreCase("A910")) {
                    sendDataToService(packageName, "A910");
                } else if (SdkConstants.DEVICE_TYPE.equalsIgnoreCase("Newland")) {
                    sendDataToService(packageName, "Newland");
                } else if (SdkConstants.DEVICE_TYPE.equalsIgnoreCase("pax")) {
                    sendDataToService(packageName, "mATM2");
                } else {
                    showDeviceTypeAlertMsg(PosServiceActivity.this);
                }
            } else {
                ...
                if (packageName.equals("com.matm.matmservice_1")) {
                    ...
                    showMatmAlert(PosServiceActivity.this);
                }
            }
        } catch (Exception e) {
...
//                    .show();
    ...
    public void showDeviceTypeAlertMsg(Context context) {
        try {
            ...
            alertbuilderupdate.setCancelable(false);
            String message = "Device type not found";
            alertbuilderupdate.setTitle("Alert")
                    .setMessage(message)
            ...
            AlertDialog alertDialog = alertbuilderupdate.create();
            alertDialog.show();
    ...
    private void sendDataToService(String packageName, String activityName) {
