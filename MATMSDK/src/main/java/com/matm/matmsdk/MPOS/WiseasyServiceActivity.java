...
public class WiseasyServiceActivity extends AppCompatActivity {
    String latLong = "";
    ...
    public void getLocation() {
        gpsTracker = new GpsTracker(WiseasyServiceActivity.this);
    ...
    public void checkAppInstalledOrNot(String packageName){
        ...
        try {
            if (installed) {
                ...
                sIntent.setFlags(0);
                sIntent.putExtra("ActivityName", "Wiseasy");
                ...
                if(packageName.equals("com.matm.matmservice_1")) {
                    showAlert(WiseasyServiceActivity.this);
                }else {
                    showMatmAlert(WiseasyServiceActivity.this);
                }
            }
        } catch (Exception e) {
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (data != null && resultCode == RESULT_OK) {
            if (data.hasExtra("error1Response")) {
                Intent intent = new Intent(WiseasyServiceActivity.this, ErrorActivity.class);
                intent.putExtra("errorResponse", data.getIntExtra("error1Response", 0));
                startActivity(intent);
                finish();
            } else if (data.hasExtra("errorResponse")) {
                Intent intent = new Intent(WiseasyServiceActivity.this, Error2Activity.class);
                intent.putExtra("errorResponse", data.getStringExtra("errorResponse"));
                startActivity(intent);
                finish();
            } else {
                Intent intent = new Intent(WiseasyServiceActivity.this, TransactionStatusActivity.class);
