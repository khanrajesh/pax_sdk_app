...
public class PaxA910ServiceActivity extends AppCompatActivity {
    String latLong = "";
    ...
    public void getLocation() {
        gpsTracker = new GpsTracker(PaxA910ServiceActivity.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (data != null && resultCode == RESULT_OK) {
            if (data.hasExtra("error1Response")) {
                Intent intent = new Intent(PaxA910ServiceActivity.this, ErrorActivity.class);
                intent.putExtra("errorResponse", data.getIntExtra("error1Response", 0));
                startActivity(intent);
                finish();
            } else if (data.hasExtra("errorResponse")) {
                Intent intent = new Intent(PaxA910ServiceActivity.this, Error2Activity.class);
                intent.putExtra("errorResponse", data.getStringExtra("errorResponse"));
                startActivity(intent);
                finish();
            } else {
                Intent intent = new Intent(PaxA910ServiceActivity.this, TransactionStatusActivity.class);
    ...
    public void checkAppInstalledOrNot(String packageName){
        ...
        try {
            if (installed) {
                ...
                sIntent.setFlags(0);
                sIntent.putExtra("ActivityName", "A910");
                ...
                if(packageName.equals("com.matm.matmservice_1")) {
                    showAlert(PaxA910ServiceActivity.this);
                }else {
                    showMatmAlert(PaxA910ServiceActivity.this);
                }
            }
        } catch (Exception e) {
        }
